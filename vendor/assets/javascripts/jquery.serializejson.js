...
(function ($) {
  ...
  $.serializeJSON = {
    ...
    isNumeric:         function(obj) { return obj - obj >= 0; }, // taken from jQuery.isNumeric implementation. Not using jQuery.isNumeric to support old jQuery and Zepto versions
